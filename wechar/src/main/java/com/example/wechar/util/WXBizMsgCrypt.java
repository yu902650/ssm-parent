...
public class WXBizMsgCrypt {
    ...
    String aeskey = PropertiesUtil.get("AESKEY");
    byte[] aesKey = Base64.decodeBase64(aeskey + "=");
    ...
    String decrypt(String text) throws Exception {
        ...
        try {
            // 设置解密模式为AES的CBC模式
            System.err.println("aesKey:" + aeskey);
            Cipher cipher = Cipher.getInstance("AES/CBC/NoPadding");
    ...
    public static void main(String[] args) {
        ...
        String msgSignature = "MpQBCnDsGIYDouzQ";

        System.err.println("" + msgSignature);
        String str = new WXBizMsgCrypt().encryptMsg("测试123", String.valueOf(timeStamp), "f0dLN0EtdSneKd");
        //decryptMsg();'
